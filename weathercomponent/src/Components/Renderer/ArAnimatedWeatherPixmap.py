...
class ArAnimatedWeatherPixmap(Renderer):
	__module__ = __name__
	...
	def __init__(self):
		...
		elif fileExists('/usr/share/enigma2/PLi-FullNightHD/piconAnimatedWeather'):
			self.path = '/usr/share/enigma2/PLi-FullNightHD/piconAnimatedWeather'	
		else:
			self.path = None
		self.pixdelay = 100
		self.control = 1
