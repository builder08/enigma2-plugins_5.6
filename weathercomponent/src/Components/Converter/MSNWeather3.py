...
class MSNWeather3(Converter, object):
    CURRENT = -1
    CITY = 0
    DAY1 = 1
    DAY2 = 2
    ...
    def getText(self):
        ...
        elif self.mode == self.SKYTEXT:
            return self.source.getSkytext()
        elif self.mode == self.VISIBILITY:
